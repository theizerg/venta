			...
			<div class="card">
				...
				<div class="card-body">                    
					<span class="float-right">
						<a class="btn btn-sm btn-success" href="/compras/nuevo" class="btn btn-link">
							<i class="fa fa-plus" aria-hidden="true"></i> Nuevo compras
						</a>
					</span>
					<ul class="list-inline">
						 ...
						 <li class="list-inline-item">
							<a href="/comprass" class="link_ruta">
								comprass &nbsp; &nbsp;<i class="fa fa-chevron-right" aria-hidden="true"></i>
							</a>
						</li>
						 <li class="list-inline-item">
					...
					<form id="formNuevoRecibo" action="/comprobantes/recibos/factura/guardar" method="post">
						{{ csrf_field() }}
								...
								<div class="form-group col-md-12">									
									<table class="table table-condensed table-striped table-bordered">
										...
										<tr>
											...
											<td>
												<a href="/clientes/detalle/{{ $proveedor->id }}">
												@if($proveedor->empresa)
													{{ $proveedor->nombre }}
												@else
									...
									<table id="tablaFacturas" cellspacing="0" width="100%" class="table table-condensed table-striped table-bordered">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a target="_blank" href="/compras/detalle/{{ $f->compras->id }}">
														{{ $f->compras->tipo->name }}
													</a>
												</td>
												<td>
													&nbsp; {{ $f->compras->moneda->simbolo }}
